...
from inim_prime.models.area import SetAreaModeRequest, AreaMode, ClearAreaAlarmMemoryRequest
...
class ClearAreaAlarmMemoryButton(
    CoordinatorEntity[InimPrimeDataUpdateCoordinator],
    ButtonEntity,
):
    def __init__(self, coordinator: InimPrimeDataUpdateCoordinator, area):
    ...
    async def async_press(self) -> None:
        ...
        await self.coordinator.client.clear_area_alarm_memory(request)
        await self.coordinator.async_request_refresh()
